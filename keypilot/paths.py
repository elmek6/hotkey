...
PAINT = FILES / "paint"  # "Paint'te ac" gecici PNG'leri (uzerine yazilir)
...
SETTINGS = FILES / "settings.json"  # settings.ahk bicimi -- keypilot.settings

# AHK'de `repository.json` idi. Bicim METIN'e gecti (bkz. repository.py):
# icerik cok satirli kod parcasi, JSON okunmaz hale getiriyordu. Bu yuzden

...
from keypilot.win32 import ocr, send, shell
...
class KeyPilot:
    def __init__(self, app: QApplication, lock: SingleInstance | None = None) -> None:
        ...
        # parametre aldigi haller. KeyPilot'in kendi metoduna giden kayitlar
        ...
        # varsayilan KAPALI (keypilot/dev.py): surekli donen bir mekanizma,

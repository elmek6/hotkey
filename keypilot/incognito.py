...
from keypilot.store import JsonStore
from keypilot.tracestore import (
    CORE,
    DEEP,
    FileGlobStore,
    PolicyGuard,
...
from keypilot.win32.filelock import ExclusiveLocks
from keypilot.win32.shell import refresh_shell

log = logging.getLogger("keypilot.incognito")
...
class Incognito:
    ...
    def _begin_snapshot(self) -> None:
        ...
        self._snap_thread = threading.Thread(
            ...
            args=(deferred,),
            name="keypilot-incognito-snapshot",
            daemon=True,
        )
